...
1. It's recommended (but not required) to install
   ...
   **Note**: If you are using rvm you need to run `bundle install` in your redmine root to install the open4 gem.
2. Get sources from [github](http://github.com/marcelhuberfoo/wiki_external_filter).
